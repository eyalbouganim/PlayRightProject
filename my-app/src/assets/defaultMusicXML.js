export const defaultMusicXML = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE score-partwise PUBLIC "-//Recordare//DTD MusicXML 4.0 Partwise//EN" "http://www.musicxml.org/dtds/partwise.dtd">
<score-partwise version="4.0">
<movement-title>Default Song: Twinkle Twinkle Little Star</movement-title>
    <part-list>
        <score-part id="P1">
            <part-name>Notes</part-name>
        </score-part>
    </part-list>
    <part id="P1">
        <measure number="1">
